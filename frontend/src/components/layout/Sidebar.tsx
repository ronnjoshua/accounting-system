...
const navigation = [
  ...
  { name: 'Receive Payments', href: '/payments/receive', icon: CreditCard },
  { divider: true, label: 'Payables' },
  { name: 'Vendors', href: '/vendors', icon: Building2 },
  { name: 'Bills', href: '/bills', icon: FileSpreadsheet },
  { name: 'Make Payments', href: '/payments/make', icon: Banknote },
  ...
  { name: 'Bank Reconciliation', href: '/banking/reconciliation', icon: Landmark },
  ...
  { name: 'Tax Management', href: '/admin/taxes', icon: Percent },
